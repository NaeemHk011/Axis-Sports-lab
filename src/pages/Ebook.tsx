...
const Ebook = () => {
  ...
  return (
    <>
      ...
      >
        <div className="relative z-10 container-x text-center w-full py-20">
          <Reveal>
            <p className="eyebrow justify-center text-primary-glow">
              <span className="h-px w-8 bg-primary-glow" /> FREE Basketball Workout
            </p>
            <h1 className="font-display text-5xl md:text-7xl xl:text-8xl uppercase text-white mt-4 leading-tight font-black">
