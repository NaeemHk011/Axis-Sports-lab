...
const whatToExpect = [
  ...
  "Confidence Building ",
  "Designed specifically for ages 5–8 ",
          ...
          <Reveal delay={0.1} className="lg:col-span-7">
            <div className="card-elite">
              ...
              <p className="mt-2 text-sm" style={{ color: isDark ? "rgba(255,255,255,0.60)" : "rgba(0,0,0,0.60)" }}>
                Select an available slot below to book your Axis Minis class.
              </p>

              <div className="mt-6 w-full rounded-xl overflow-hidden" style={{ background: isDark ? "#0a0a0a" : "#ffffff" }}>
                <BookingIframe
                  src="https://link.webtechs.dev/widget/booking/6uTcp8Km7rDPLt1jCuQ0"
                  id="vLY9yutjEVlB0FM88Ima_1782165602493"
                  title="Axis Minis Booking"
