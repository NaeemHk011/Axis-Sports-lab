          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/65">
              ...
              <li className="flex gap-3 items-center">
                ...
                <a href="tel:+13465508150" className="hover:text-white transition-colors">(346) 517 8623</a>
              </li>
              <li className="flex gap-3 items-center">
              ...
              <li className="flex gap-3 items-start pt-1">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 shrink-0 text-primary-glow mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
